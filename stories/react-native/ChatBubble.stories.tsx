...
export const Alignments: Story = {
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16, maxWidth: 480 }}>
      <div style={{ fontSize: 11, color: '#94A0B8', textTransform: 'uppercase', letterSpacing: 1 }}>Incoming (left)</div>
      <ChatBubble align="incoming" timestamp="2:30 PM">
        Hey, are you free for a call later?
      </ChatBubble>

      <div style={{ fontSize: 11, color: '#94A0B8', textTransform: 'uppercase', letterSpacing: 1 }}>Outgoing (right)</div>
...
export const Variants: Story = {
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16, maxWidth: 480 }}>
      <div style={{ fontSize: 11, color: '#94A0B8', textTransform: 'uppercase', letterSpacing: 1 }}>Default incoming</div>
      <ChatBubble align="incoming">Default variant — theme surface colors</ChatBubble>

      <div style={{ fontSize: 11, color: '#94A0B8', textTransform: 'uppercase', letterSpacing: 1 }}>Default outgoing</div>
      <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
        <ChatBubble align="outgoing">Default outgoing — raised surface</ChatBubble>
      </div>

      <div style={{ fontSize: 11, color: '#94A0B8', textTransform: 'uppercase', letterSpacing: 1 }}>Accent outgoing</div>
      <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
