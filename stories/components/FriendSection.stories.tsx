/**
 * FriendSection — Stories showing all variants and usage patterns.
 *
 * @module stories/friend-section
 */

import React from 'react';
import type { Meta, StoryObj } from '@storybook/react';
import { FriendSection, FriendListItem, Avatar } from '@wisp-ui/react';

const meta: Meta<typeof FriendSection> = {
  title: 'React/Components/Social/FriendSection',
