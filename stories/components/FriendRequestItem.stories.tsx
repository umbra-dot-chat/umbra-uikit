/**
 * FriendRequestItem — Stories showing all variants and usage patterns.
 *
 * @module stories/friend-request-item
 */

import React from 'react';
import type { Meta, StoryObj } from '@storybook/react';
import { FriendRequestItem, Avatar } from '@wisp-ui/react';

const meta: Meta<typeof FriendRequestItem> = {
  title: 'React/Components/Social/FriendRequestItem',
