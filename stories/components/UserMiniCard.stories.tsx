/**
 * UserMiniCard — Stories showing all variants and usage patterns.
 *
 * @module stories/user-mini-card
 */

import React from 'react';
import type { Meta, StoryObj } from '@storybook/react';
import { UserMiniCard, Avatar } from '@wisp-ui/react';

const meta: Meta<typeof UserMiniCard> = {
  title: 'React/Components/Social/UserMiniCard',
