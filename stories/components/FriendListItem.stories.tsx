/**
 * FriendListItem — Stories showing all variants and usage patterns.
 *
 * @module stories/friend-list-item
 */

import React from 'react';
import type { Meta, StoryObj } from '@storybook/react';
import { FriendListItem, Avatar } from '@wisp-ui/react';

const meta: Meta<typeof FriendListItem> = {
  title: 'React/Components/Social/FriendListItem',
